...
const questions = [
    {
        id: '2.1_1',
        question: 'Задача 1. Вводиться перший номер місяця якоїсь пори року (3,6,9,12). Визначити пору року. Передбачити перевірку і генерувати помилку якщо некоректний місяць (1-12) і генерувати помилку якщо це не перший місяць пори року. Використати never.',
        checkFunction: function () {
            ...
            const monthInput = prompt('Введіть перший місяць пори року (3,6,9,12)');
            const month = Number(monthInput);
            let season = getSeason(month);
            console.log(`Пора року: ${season}`);
            document.write(`<div>Пора року: ${season}</div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '2.1_2',
        question: 'Задача 2. Створити функцію, яка дозволяє знайти або останню цифру числа, або останній символ числа.',
        checkFunction: function () {
            let inputNumber = 1234;
            let inputString = 'Hello';
            function getLastTyped(value) {
    ...
    {
        id: '2.1_3',
        question: 'Задача 3. Вводиться номер місяця або назва місяця. Створити функцію, яка повинна повертати номер пори року (1-4) якщо передаємо число, або назву пори року, якщо було введено назву місяця. Використати перевантаження функцій.',
        checkFunction: function () {
            const userInput = prompt('Введіть номер місяця (від 1 до 12) або його назву');
            let monthsValue = userInput && !isNaN(Number(userInput)) ? Number(userInput) : userInput || '';
            ...
            document.write(`<div>Вибраний місяць -  <b>${monthName}</b>, і він відноситься до пори року: <b>${result}</b></div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '2.1_4',
        question: 'Задача 4. Випадковим чином генерується масив номерів робочих днів, або назв вихідних, або назв святкових днів. Підрахувати чого було більше: святкових чи вихідних.',
        checkFunction: function () {
    ...
    {
        id: '2.1_5',
        question: 'Задача 5. Дано набір налаштувань (ключ-значення(enabled/disabled)). Вивести ті, які є увімкненими',
        checkFunction: function () {
            function getEndabledSettings(settings) {
            ...
            document.write(`<div>Увімкнені налаштування: ${endabled.join(', ')}</div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '2.1_6',
        question: 'Задача 7. Згенерувати масив нагород (золота, срібна, бронзова медалі та грамота). Підрахувати кількість кожної з нагород. Використати enum. Можете і never якось застосувати',
        checkFunction: function () {
            let Reward;
            (function (Reward) {
                Reward["Gold"] = "\u0417\u043E\u043B\u043E\u0442\u0430 \u043C\u0435\u0434\u0430\u043B\u044C";
                Reward["Silver"] = "\u0421\u0440\u0456\u0431\u043D\u0430 \u043C\u0435\u0434\u0430\u043B\u044C";
                Reward["Bronze"] = "\u0411\u0440\u043E\u043D\u0437\u043E\u0432\u0430 \u043C\u0435\u0434\u0430\u043B\u044C";
                Reward["Diploma"] = "\u0413\u0440\u0430\u043C\u043E\u0442\u0430";
            })(Reward || (Reward = {}));
    ...
    // ========================================================================================================================================
    {
        ...
        checkFunction: function () {
            function showCurrentDate() {
                ...
                document.write(`<div>Сьогоднішня дата: ${formattedDate}</div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
            }
            showCurrentDate();
        },
    },
    {
        id: '2.3_2',
        question: 'З клавіатури номер робочого дня. Ввисти скільки залишилось до кінця тижня. Передбчати генерування виглючних ситуацій якщо номер дня некоректний і коли номер дня коректний, але це не є робочим днем (використати функцію з never для генерування виключиних ситуацій)',
        checkFunction: function () {
            ...
            if (inputDay === null)
                throwError('Введено скасування');
            const day = parseInt(inputDay);
            if (isNaN(day))
                throwError('Введено не число');
            function getLastWorkingDays(day) {
                if (day < startWorkingDay || day > daysInWeek)
                    throwError('Некоректнтий день тижня');
                if (day > endWorkingDay)
                    throwError('Некоректнтий робочий тдень');
                return 6 - day;
            }
    ...
    },
    {
        ...
        checkFunction: function () {
            function getCloth() {
                ...
                if (input === null)
                    throw new Error('Введено скасування');
                const seasonInput = input.toLowerCase();
                let cloth;
                switch (seasonInput) {
                    case 'winter':
                    ...
                    case 'autumn':
                        ...
                        break;
                    default:
                        const _exCheck = seasonInput;
                        throw new Error(`Не вірно вказано сезон`);
                }
                return cloth;
            }
            document.write(`<div>${getCloth()}</div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '2.3_4',
        question: 'Передається або номер дня, або назву дня на англійькій. Треба сказати чи вихідний чи робочий.',
        checkFunction: function () {
            ...
            document.write(`<div>${isWorkingDay(3).toString()}</div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '2.3_5',
        question: 'Передається або номер дня, або назву дня на англійькій. Треба повертати  номер наступного дня (якщо число), або першу літеру (якщо назва)',
        checkFunction: function () {
            let inputDay = prompt('Введіть номер дня тижня (1-7) або назву дня (Mon, Tue, Wed, Thu, Fri, Sat, Sun):');
            if (inputDay === null)
                throw new Error('Введено скасування');
            ...
            document.write(`<div>${isWorkingDay(day).toString()}</div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '2.3_6',
        question: 'Планувальник відпусток. Дано масив імен водіїв і масив номерів, коли можна йти у відпустку. Потрібно випадково вибрати ім’я водія і випадково вибрати номер місяця для відпустки.',
        checkFunction: function () {
            var _a, _b, _c;
            let drivers = ['Andrii', 'Olga', 'Viktor'];
            drivers = (_b = (_a = prompt("Введіть ім'я водія")) === null || _a === void 0 ? void 0 : _a.split(', ')) !== null && _b !== void 0 ? _b : [];
            let vacMonths;
            vacMonths =
                (_c = prompt('Введіть місяці відпустки')
                    .split(', ')
                    .map((m) => Number(m))) !== null && _c !== void 0 ? _c : [];
            ...
            document.write(`<div>${drName} - ${vacMonth}</div>
        <div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '2.3_7',
        question: 'Сформувати масив значень ігрового барабана. Це або виграшна сума, або «Пауза», «Банкрот», «Супер приз»',
        checkFunction: function () {
            let gameListType;
            function getGameField(cellCount) {
                const list = [];
            ...
            const arr = getGameField(10);
            console.log(arr);
            document.write(`<div>${arr}</div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '2.3_8',
        question: ' Сформувати двовимірний масив (5*5) ігрового поля. Усі елементи нулі, або 1-корабель (4 штуки), або ‘block’- земля (5 штук)',
        checkFunction: function () {
            function getZeroMatrix(rowNum, colNumber) {
                const matrix = [];
            ...
            function setInRandomPosition(val, valNumber, matrix) {
            ...
            function generateGameField(rowNum, colNumber, shipNum, groundNum) {
                const gameFieldMatrix = getZeroMatrix(rowNum, colNumber);
            ...
            let tableHTML = '<table border="1" cellspacing="0" cellpadding="5" style="text-align:center;">';
    ...
    {
        id: '2.3_9',
        question: 'Дано масив маркерів на картів [lat, long, city]. Визначити найближче місто до вказаних координат',
        checkFunction: function () {
            function getMarkersList(markersNumber) {
                const markersList = [];
                for (let i = 0; i < markersNumber; i++) {
                    const city = prompt(`Введіть назву міста ${i + 1}`) || '';
                    const latInput = prompt(`Вкажіть координати міста ${city}`);
                    const lat = Number(latInput);
                    const longInput = prompt(`Введіть довготу міста ${city}`);
            ...
            function getClosestCity(markerList, target) {
                let closestCity = null;
                let minDistance = Infinity; // Початкова мінімальна відстань
                for (let marker of markerList) {
                    const distance = Math.sqrt(Math.pow(marker[0] - target[0], 2) + Math.pow(marker[1] - target[1], 2));
            ...
            const numCities = Number(prompt('Скільки міст додати?') || '0');
    ...
    {
        id: '2.3_11',
        question: 'Потрібно ввести стать студента ("male", "female"). У залежносі від цього додати Mr, Ms.',
        checkFunction: function () {
            let Gender;
            (function (Gender) {
                Gender["Male"] = "male";
            ...
            const genderInput = prompt('Введіть стать (male / female)');
            if (!genderInput)
                throw new Error('Стать не може бути порожньою');
            ...
            document.write(`<div>${fullName}</div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '2.3_12',
        question: 'Вводиться сума грошей і позначення валюти. Потрібно перевести кількість гривень у кількість обраної валюти ("USD" ,  "EUR" , "UAH")',
        checkFunction: function () {
            function convertToCurrency() {
                ...
                const USD_RATE = 42;
                const EUR_RATE = 48;
                const moneyInput = prompt('Вкажіть кількість гривень');
                if (!moneyInput)
                    throw new Error('Ввід скасовано');
                const moneyGrn = Number(moneyInput);
                if (isNaN(moneyGrn) || moneyGrn <= 0)
                ...
                console.log(result);
                document.write(`<div>${result}</div><div><a href="../components/lesson2.html">Повернутися до уроку</a></div>`);
            }
            convertToCurrency();
        },
    },
