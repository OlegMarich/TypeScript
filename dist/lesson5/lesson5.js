...
const questions = [
    {
        id: '5.1_1',
        question: 'Приклад. Створити товар. Для товару зберігаються назва товару,  ціна, кількість та вартість зберігання в день. Передбачити можливість знаходження загальної вартості наявної кількості одиниць, визначення вартості зберігання для заданої кількості днів, зменшення ціни на вказану кількість відсотків та збільшення ціни на вказану кількість відсотків',
        checkFunction: function () {
            ...
            document.write(`<div>${productOne}</div><div><a href="../components/lesson5.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '5.1_2',
    ...
    },
    {
        ...
        checkFunction: function () {
            ...
            // console.log(clientOne.Balance);
            document.write(`<div>${clientOne.Balance}</div><div><a href="../components/lesson5.html">Повернутися до уроку</a></div>`);
        },
    },
    {
        id: '5.1_4',
        question: 'Задача. Розробити клас, який має метод для генерування випадкового числа у деякому діапазоні. Прив’язати цей метод до кнопки.',
        checkFunction: function () {
    ...
    {
        id: '5.1_5',
        question: '// Лічильник створених екземплярів класу. Використовується для відстеження кількості створених об’єктів певного типу.',
        checkFunction: function () {
            const objectNumber1 = new TestClass(prompt('Введіть перше число:') || 0, prompt('Введіть друге число:') || 0);
            const objectNumber2 = new TestClass(prompt('Введіть друге число:') || 0, prompt('Введіть друге число:') || 0);
            const objectNumber3 = new TestClass(prompt('Введіть третє число:') || 0, prompt('Введіть третє число:') || 0);
            console.log('Кількість створених об’єктів:', TestClass.objectNumber);
            // Виведе: 3
            document.write(`<div>Кількість створених об’єктів: ${TestClass.objectNumber}</div><div><a href="../components/lesson5.html">Повернутися до уроку</a></div>`);
        },
    },
    //==================================================================
    {
